...
<body>
	...
	<main>
		<div class="container">
		<h1 style="margin-bottom: 20px; margin-top: 30px;">상품등록</h1>
		<form action="goodswrite" method="post">
			...
			<div style="margin-bottom: 20px;">
				<h2 style="margin-bottom: 20px;">상품분류</h2> <h3>채소</h3> <input type="radio" name="sub_cat_code"
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					...
					name="sub_cat_code" id="sub_cat_code" value="106" />콩나물.버섯 <br /> <h3 style="margin-top: 20px;">과일</h3> <input
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					...
					id="sub_cat_code" value="207" />쌀.잡곡 <br /> <h3 style="margin-top: 20px;">수산</h3> <input type="radio"
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					...
					id="sub_cat_code" value="308" />건어물.다시팩 <br /> <h3 style="margin-top: 20px;">정육</h3> <input type="radio"
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					value="407" />양고기 <br /> <h3 style="margin-top: 20px;">국.반찬.메인</h3> <input type="radio" name="sub_cat_code"
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					...
					id="sub_cat_code" value="505" />베이컨.햄.통조림 <br /> <h3 style="margin-top: 20px;">샐러드.간편식</h3> <input type="radio"
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					...
					id="sub_cat_code" value="608" />선식.시리얼 <br /> <h3 style="margin-top: 20px;">면.양념.오일</h3> <input type="radio"
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					...
					id="sub_cat_code" value="705" />소금.설탕.향신료 <br /> <h3 style="margin-top: 20px;">생수.음료.우유.커피</h3> <input type="radio"
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					...
					name="sub_cat_code" id="sub_cat_code" value="805" />차 <br /> <h3 style="margin-top: 20px;">간식.과자.떡</h3> <input
				...
				<input type="radio" name="sub_cat_code" id="sub_cat_code"
					...
					name="sub_cat_code" id="sub_cat_code" value="904" />아이스크림 <br /> <h3 style="margin-top: 20px;">베이커리.치즈.델리</h3> <input

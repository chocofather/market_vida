	...
	<div class="footer">
        ...
        <div class="sns">
            <div class="sns_img">
                ...
                <a href="https://www.instagram.com/"><img src="${path}/resources/img/insta.png" alt="인스타그램"></a>
                <a href="https://twitter.com/"><img src="${path}/resources/img/twitter.png" alt="트위터"></a>
            </div>
        </div>
    </div>